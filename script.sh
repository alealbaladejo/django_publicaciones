...
echo "from django.contrib.auth import get_user_model; User = get_user_model(); User.objects.create_superuser('alejandro', 'ale@ale', 'alejandro29.')" | python manage.py shell
